...
void TextureManager::loadTexture(VulkanContext& ctx, const std::string& path) {
    createTextureImage(ctx, path);
...
void TextureManager::createTextureImage(VulkanContext& ctx, const std::string& path) {
    ...
    Image::copyBufferToImage(ctx, stagingBuffer, textureImage,
...
void TextureManager::createTextureImageView(VulkanContext& ctx) {
    textureImageView = Image::createImageView(ctx, textureImage,
